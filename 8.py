#Uma academia deseja fazer um censo entre seus clientes para descobrir o mais alto,
#o mais baixo, o mais gordo e o mais magro, para isto você deve fazer um programa que
